...
def make_new_student(first_name,last_name,github):
    ...
    CONN.commit()
    return get_student_by_github(github)
...
#    print "Successfully added project: %s %s"%(title, description)
    return get_project_by_title(title)
...
#        JOIN Students ON (Students.github = Grades.student_github)
#        WHERE project_title = ?"""
    query = """SELECT Students.first_name, Students.last_name, Grades.project_title, Grades.grade, Grades.student_github
        FROM Grades JOIN Projects ON (Grades.project_title = Projects.title)
        JOIN Students ON (Students.github = Grades.student_github)
        WHERE project_title = ?"""
...
def give_grade(student_github, project_title, grade):
    ...
    return get_grade_by_student_project(student_github,project_title)
